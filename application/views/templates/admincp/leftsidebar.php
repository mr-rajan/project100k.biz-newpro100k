  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">        
        ...
        <li class="treeview <?php echo (strpos($_SERVER['REQUEST_URI'],'promotion')) ? 'active' : ''?>">
          <a href="#">
            <i class="fa fa-rss"></i> <span>Promotion Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu <?php echo (strpos($_SERVER['REQUEST_URI'],'promotion')) ? 'menu-open' : ''?>" 
		  <?php echo (strpos($_SERVER['REQUEST_URI'],'promotion') || strpos($_SERVER['REQUEST_URI'],'promotioncategory')) ? 'style="display:block;"' : 'style:"display:none;"'?>>
            <li <?php echo (strpos($_SERVER['REQUEST_URI'],'promotion')) ? 'class="active"': ''?> >
            <a href="<?php echo base_url().'admincp/promotion'?>"><i class="fa fa-circle-o"></i>Cateogory Lists</a></li>
            <?php get_promotion_categories_lists();?>
