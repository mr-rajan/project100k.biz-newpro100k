 <?php $this->load->view('templates/admincp/leftsidebar')?>
  ...
  <div class="content-wrapper">
    ...
    <?php if($this->session->flashdata('admincp_urlbanner_flash_message')) { 
				echo '<div id="sessionMessageDiv" style="padding:10px;">'.$this->session->flashdata('admincp_urlbanner_flash_message').'</div>';
